...
function getScrollableNode(ref: React.RefObject<ScrollableWrapper> | React.RefObject<WebView>) {
  if (ref?.current == null) {
    return null;
  }
...
export function useScrollToTop(
  ref: React.RefObject<ScrollableWrapper> | React.RefObject<WebView> | React.Ref<any>,
  offset: number = 0
) {
      ...
      return tab.addListener(
        ...
        (e: EventArg<'tabPress', true>) => {
          ...
          requestAnimationFrame(() => {
            const scrollable = getScrollableNode(ref) as ScrollableWrapper | WebView;
